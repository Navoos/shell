...
SRC = minishell.c env.c gc.c debug_env.c tokenizer.c debug_tokenizer.c tokenizer_manager.c tokenizer_manager_extension1.c \
		...
		ft_exec_cd.c ft_exec_echo.c ft_exec_env_crud.c ft_exec_env_utils.c ft_exec_env.c ft_exec_main.c ft_exec_pwd.c ft_exec_shell.c ft_exec_utils.c ft_exec_pipe.c ft_exec_exit.c ft_exec_redir.c
